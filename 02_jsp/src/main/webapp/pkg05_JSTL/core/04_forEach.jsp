...
<body>
  <%--
    <c:forEach>
    1. 일반 for 문과 향상 for 문을 모두 처리 할 수있다.
    2. 일반 for 문 형식
  ...
  <%-- 향상 for 문 (배열) --%>
  <% pageContext.setAttribute("seasons", new String[]{"봄", "여름", "가을", "겨울"}); %>
  ...
  <%
    ...
    list.add(new Post("기사제목1", "기자1", "작성일자1"));
    list.add(new Post("기사제목2", "기자2", "작성일자2"));
    list.add(new Post("기사제목3", "기자3", "작성일자3"));
